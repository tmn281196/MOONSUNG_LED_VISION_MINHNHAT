                        ...
                        "EN", new HelpText
                        {
                            ...
                            Sections = new[]
                            {
                                ...
                                new Section("2. Commands",
                                    ...
                                    "VISION CHECK : the camera checks one LED group. Target = group name (Vision page → LED Group). Timeout = sampling time in ms (default 2000, one sample every 100 ms). By default an ROI is OK when at least one sample shows it lit with the right colour (pass rule on the Setting page; the strict rule needs every sample); Persist warm-up samples are not scored."),
