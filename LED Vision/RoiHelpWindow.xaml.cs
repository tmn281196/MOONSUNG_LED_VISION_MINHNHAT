                        ...
                        "EN", new HelpText
                        {
                            ...
                            Sections = new[]
                            {
                                new Section("1. What the sequence is",
                                    ...
                                    "When the test ends (PASS or NG) the app switches the LED power and all relays OFF. On PASS the jig is raised; on NG it stays down and the ROIs of the last check stay on screen. EMERGENCY STOP switches everything off."),
                        ...
                        "TH", new HelpText
                        {
                            ...
                            Sections = new[]
                            {
                                new Section("1. ลำดับการทดสอบคืออะไร",
                                    ...
                                    "เมื่อการทดสอบจบ (PASS หรือ NG) แอปจะปิดไฟ LED และรีเลย์ทั้งหมด PASS จะยกจิ๊กขึ้น NG จิ๊กอยู่ล่างและ ROI ของการตรวจล่าสุดยังแสดงอยู่ EMERGENCY STOP ปิดทุกอย่าง"),
