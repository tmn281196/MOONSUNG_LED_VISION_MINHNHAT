                        ...
                        "TH", new HelpText
                        {
                            ...
                            Sections = new[]
                            {
                                ...
                                new Section("2. คำสั่ง",
                                    ...
                                    "VISION CHECK : กล้องตรวจกลุ่ม LED หนึ่งกลุ่ม Target = ชื่อกลุ่ม (หน้า Vision → LED Group) Hold = เวลาที่ ROI ต้อง OK ต่อเนื่องเป็น ms (ว่าง = หนึ่งตัวอย่าง) Timeout = เวลารอสูงสุดเป็น ms (ค่าเริ่มต้น 2000 เก็บทุก 100 ms) Hold = ROI แต่ละอันต้องติดถูกสีต่อเนื่องนานเท่านี้ (ms) จึงถือว่า OK ว่าง = หนึ่งตัวอย่าง Timeout = เวลารอสูงสุด PASS ทันทีเมื่อ ROI ทุกอันถึง Hold ROI ที่ไม่เคยถึงจะ NG (เปลี่ยนกฎได้ในหน้า Setting กฎเข้มงวดต้องติดทุกตัวอย่างตลอด Timeout)"),
